    ...
    <>
      <div className="h-screen w-screen flex justify-center item-center">
        <div className="w-1/2 flex flex-col justify-center items-center">
          <h1 className="font-bold text-gray-700 uppercase text-3xl">
            ...
            >
              ...
              <div className="flex flex-col my-7">
                ...
                <input
                  ...
                  className="bg-gray-100 w-80 rounded-lg p-2"
                  onChange={(e) => {
                    setUser({
                      ...user,
              ...
              <button
                type="submit"
                className="font-medium text-white text-sm bg-blue-900 w-20 rounded-md p-2 my-6"
              >
                Login
              </button>
            </form>
